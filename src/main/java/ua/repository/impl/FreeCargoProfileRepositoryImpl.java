...
import ua.repository.FreeCargoProfileRepository;
...
@Repository
public class FreeCargoProfileRepositoryImpl implements FreeCargoProfileRepository {

	@PersistenceContext
	private EntityManager em;
	
	@Override
	public Page<CargoView> findAllFreeCargo(String name, CargoFilter filter, Pageable pageable) {
...
//Integer id, Integer ownerId, Goods goods, String weight, String height, String width, String length, City cityFrom, City cityTo, Owner owner, String price,Integer transporterId, String status
		...
		Join<Owner, User> userJoin = ownerJoin.join("user");
