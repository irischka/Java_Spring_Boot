...
//Integer id, Integer ownerId, Goods goods, String weight, String height, String width, String length, City cityFrom, City cityTo, Owner owner, String price
		cq.multiselect(root.get("id"), root.get("goods"), root.get("weight"), root.get("height"), root.get("width"), root.get("length"),root.get("cityFrom"), root.get("cityTo"), root.get("price") );
...
private static class PredicateBuilder {
		...
		void findFreeCargo() {
				predicates.add(cb.equal(root.get("transporterId"), 0));
		}
